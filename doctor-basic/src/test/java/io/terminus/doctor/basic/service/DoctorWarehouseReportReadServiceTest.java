...
public class DoctorWarehouseReportReadServiceTest {
    ...
    public void testCountFarmBalance() {
        ...
        Assert.assertEquals(6925, balance.getResult().getQuantity().doubleValue(), 2);
    }
    ...
    public void testCountBalanceEachWarehouseType() {
        ...
        Assert.assertEquals(19456, feedBalance.getQuantity().doubleValue(), 2);
        ...
        Assert.assertEquals(114696, materialBalance.getQuantity().doubleValue(), 2);
        ...
        Assert.assertEquals(1090, vaccBalance.getQuantity().doubleValue(), 2);
        ...
        Assert.assertEquals(9928.2, mediBalance.getQuantity().doubleValue(), 2);
    ...
    public void testCountWarehouseBalance() {
        ...
        Assert.assertEquals(6000, balance.getQuantity().doubleValue(), 2);
    }
    ...
    public void testCountEachMaterialBalance() {
        ...
        Assert.assertEquals(185, balance228.getQuantity().doubleValue(), 2);
        AmountAndQuantityDto balance227 = eachSkuBalance.get(227L);
        Assert.assertEquals(475000L, balance227.getAmount());
        Assert.assertEquals(95, balance227.getQuantity().doubleValue(), 2);
    }
