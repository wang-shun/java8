...
//                Date date = DateUtil.formatToDate(DateUtil.YYYYMM, settlementDate);
            ...
            Map<String, Object> all = this.countInfo(resultList, (Long) criteria.get("orgId"), date);
            resultList.add(all);
...
//        List<Map> dataByMaterialName = doctorWarehouseMaterialHandleDao.getDataByMaterialName(id);
    ...
    private Map<String, Object> countInfo(List<Map> resultList,Long orgId,Date date){
