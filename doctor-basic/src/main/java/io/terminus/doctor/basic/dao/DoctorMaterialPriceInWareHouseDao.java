...
public class DoctorMaterialPriceInWareHouseDao extends MyBatisDao<DoctorMaterialPriceInWareHouse> {
    ...
    public DoctorMaterialPriceInWareHouse findMaterialDatas(Long farmId, Long materialId, Long wareHouseId, Date endDate) {
        return this.getSqlSession().selectOne(sqlId("findMaterialData"), ImmutableMap.of("farmId", farmId, "materialId", materialId, "wareHouseId", wareHouseId, "endDate", endDate));
    }
