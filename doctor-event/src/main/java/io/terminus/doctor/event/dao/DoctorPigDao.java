...
public class DoctorPigDao extends MyBatisDao<DoctorPig> {
     ...
     * @return 猪id列表
     */
    public List<Long> findPigIdsByFarmId(Long farmId) {
        return getSqlSession().selectList(sqlId("findPigIdsByFarmId"), farmId);
    }
     ...
     * @return
     */
    public List<DoctorPig> suggestSowPig(Long farmId, String name, Integer count){
