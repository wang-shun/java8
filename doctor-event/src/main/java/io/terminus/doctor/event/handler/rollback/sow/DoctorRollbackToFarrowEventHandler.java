 ...
 */
public class DoctorRollbackToFarrowEventHandler extends DoctorAbstractRollbackPigEventHandler{
    @Override
    protected boolean handleCheck(DoctorPigEvent pigEvent) {
        return Objects.equals(pigEvent.getType(), PigEvent.TO_FARROWING.getKey()) && isLastEvent(pigEvent);
    }
