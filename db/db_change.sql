...
insert into doctor_report_fields(id,name,type,created_at,updated_at)values(135,'公猪站',1,now(),now());
insert into doctor_report_fields(id,name,f_id,type,created_at,updated_at)values(136,'期初存栏',135,2,now(),now());
insert into doctor_report_fields(id,name,type,created_at,updated_at)values(137,'（活公猪）',1,now(),now());
insert into doctor_report_fields(id,name,f_id,type,created_at,updated_at)values(138,'转入数量',137,2,now(),now());
insert into doctor_report_fields(id,name,f_id,type,created_at,updated_at)values(139,'死亡数量',137,2,now(),now());
insert into doctor_report_fields(id,name,f_id,type,created_at,updated_at)values(140,'淘汰数量',137,2,now(),now());
insert into doctor_report_fields(id,name,f_id,type,created_at,updated_at)values(141,'销售数量',137,2,now(),now());
insert into doctor_report_fields(id,name,f_id,type,created_at,updated_at)values(142,'其他减少',137,2,now(),now());
insert into doctor_report_fields(id,name,f_id,type,created_at,updated_at)values(143,'期末存栏',137,2,now(),now());
