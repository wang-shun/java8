...
CREATE TABLE `doctor_pig_daily` (
`id` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
`sum_at` date NOT NULL COMMENT '日期',
`farm_id` bigint(20) NOT NULL COMMENT '猪场id',
`sow_start` int(11) DEFAULT NULL COMMENT '母猪期初存栏',
`sow_dead` int(11) DEFAULT NULL COMMENT '母猪死亡数量',
`sow_weed_out` int(11) DEFAULT NULL COMMENT '母猪淘汰数量',
`basic_sow_dead_and_weed_out_rate` int(11) DEFAULT NULL COMMENT '基础母猪死淘率',
`sow_sale` int(11) DEFAULT NULL COMMENT '母猪销售数量',
`sow_chg_farm` int(11) DEFAULT NULL COMMENT '母猪转场数量',
`sow_other_out` int(11) DEFAULT NULL COMMENT '母猪其他减少',
`sow_ph_reserve_in` int(11) DEFAULT NULL COMMENT '母猪后备转入',
`sow_other_in` int(11) DEFAULT NULL COMMENT '母猪其他转入',
`sow_daily_quantity` int(11) DEFAULT NULL COMMENT '母猪日均存栏',
`sow_end` int(11) DEFAULT NULL COMMENT '母猪期末存栏',
...
`sow_cf_in_farm_in` int(11) DEFAULT NULL COMMENT '产房母猪其他转入',
...
`early_mating` int(11) DEFAULT NULL COMMENT '产房前期配种数量',
`early_farrow_nest` int(11) DEFAULT NULL COMMENT '产房前期分娩窝数',
`early_farrow_rate` int(11) DEFAULT NULL COMMENT '产房前推分娩率',
`late_farrow_nest` int(11) DEFAULT NULL COMMENT '产房后期分娩窝数',
`late_farrow_rate` int(11) DEFAULT NULL COMMENT '产房后推分娩率',
`farrow_nest` int(11) DEFAULT NULL COMMENT '产房分娩窝数',
`farrow_all` int(11) DEFAULT NULL COMMENT '产房产仔总数',
...
`farrow_sjmh` int(11) DEFAULT NULL COMMENT '产房黑木畸数',
`avg_farrow` int(11) DEFAULT NULL COMMENT '产房窝均产仔数',
`avg_farrow_live` int(11) DEFAULT NULL COMMENT '产房窝均活仔数',
`avg_farrow_health` int(11) DEFAULT NULL COMMENT '产房窝均健仔数',
`avg_farrow_weak` int(11) DEFAULT NULL COMMENT '产房窝均弱仔数',
`weight` int(11) DEFAULT NULL COMMENT '产房窝重之合',
`avg_weight` int(11) DEFAULT NULL COMMENT '产房平均窝重',
`first_weight` int(11) DEFAULT NULL COMMENT '产房初生重',
...
`updated_at` date DEFAULT NULL COMMENT '创建日期',
`created_at` date DEFAULT NULL COMMENT '更新日期',
`version` int(11) DEFAULT NULL COMMENT '版本号',
  PRIMARY KEY (`id`),
  KEY `idx_doctor_group_dailies_farm_id` (`farm_id`),
  KEY `idx_doctor_group_dailies_sum_at` (`sum_at`)
