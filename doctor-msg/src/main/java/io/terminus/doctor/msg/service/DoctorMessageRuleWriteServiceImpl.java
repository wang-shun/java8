...
public class DoctorMessageRuleWriteServiceImpl implements DoctorMessageRuleWriteService {
    ...
    @Override
    public void initTemplate(Long farmId) {
        Map m = Maps.newHashMap();
        m.put("category", 1);
//        DoctorMessageRuleTemplate b = new DoctorMessageRuleTemplate();
//        b.setCategory(1);
        List<DoctorMessageRuleTemplate> doctorMessageRuleTemplates = doctorMessageRuleTemplateDao.list(m);
        System.out.println(doctorMessageRuleTemplates.size());
    }
}
