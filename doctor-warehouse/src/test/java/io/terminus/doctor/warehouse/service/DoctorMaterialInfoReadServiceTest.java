...
public class DoctorMaterialInfoReadServiceTest extends BasicServiceTest {
    ...
    public void testPagingMaterialInfo(){
        Response<Paging<DoctorMaterialInfo>> pagingResponse = doctorMaterialInfoReadService.pagingMaterialInfos(12345l,null, null, 1, 2);
        ...
        // validate
        Response<Paging<DoctorMaterialInfo>> pagingResponse2 = doctorMaterialInfoReadService.pagingMaterialInfos(12345l, 1 ,null, null, null);
