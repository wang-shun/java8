...
public class DoctorStaffWriteServiceImpl implements DoctorStaffWriteService{
    ...
    public Response<Long> createDoctorStaff(DoctorStaff staff) {
        ...
        try{
            ...
            log.error("createDoctorStaff failed, staff:{}, cause:{}", staff, Throwables.getStackTraceAsString(e));
    ...
    public Response<Boolean> updateDoctorStaff(DoctorStaff staff) {
        ...
        try{
            ...
            log.error("updateDoctorStaff failed, staff:{}, cause:{}", staff, Throwables.getStackTraceAsString(e));
    ...
    public Response<Boolean> deleteDoctorStaff(Long staffId) {
        ...
        try{
            ...
            log.error("createDoctorStaff failed, staffId:{}, cause:{}", staffId, Throwables.getStackTraceAsString(e));
