...
CREATE TABLE `doctor_daily_reports` (
  ...
  `boar_weed_out` int(11) DEFAULT NULL COMMENT '淘汰母猪',
  `boar_sale` int(11) DEFAULT NULL COMMENT '母猪销售',
  `boar_other_out` int(11) DEFAULT NULL COMMENT '母猪其他减少',
...
> 5. 更新 doctor\_pig\_events

```sql
-- 更新猪事件表barn_type
update doctor_pig_events a , doctor_barns b
set a.barn_type = b.pig_type
