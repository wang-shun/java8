...
public class WarehouseMateriaApplyController {
   ...
   @RpcConsumer
    ...
    public Map<String,Object> selectPigGroupApply(@PathVariable Integer farmId,
        ...
        return RespHelper.or500(doctorWarehouseMaterialApplyReadService.selectPigGroupApply(farmId,pigType,pigName,pigGroupName,skuType,skuName,openAt,closeAt));
    }
}
