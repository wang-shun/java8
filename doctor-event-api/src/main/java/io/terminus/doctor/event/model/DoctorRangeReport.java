...
public class DoctorRangeReport extends DoctorIndicatorReport implements Serializable {
    ...
    /**
     * 胎次、品种分布
     * @see io.terminus.doctor.event.dto.DoctorStockDistributeDto
     */
    private String extra;

    private DoctorStockDistributeDto stockDistributeDto;
    ...
    public void setExtra(String extra){
        ...
        if(!Strings.isNullOrEmpty(extra)){
            this.stockDistributeDto = JsonMapperUtil.JSON_NON_DEFAULT_MAPPER.fromJson(extra, DoctorStockDistributeDto.class);
        }
    }
}
