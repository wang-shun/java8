...
public interface DoctorDeliveryReadService {
    ...
    List<Map<String,Object>> boarReport(Long farmId,Integer boarsStatus,Date queryDate,String pigCode,String staffName,Integer barnId,Integer breedId,Date beginDate,Date endDate);
